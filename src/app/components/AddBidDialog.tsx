                ...
                {form.isStart === '1' && (
                  <>
                    ...
                    <div>
                      ...
                      <Input type="date" value={form.startTime} onChange={(e) => set('startTime', e.target.value)} className="w-full" />
                    </div>
            ...
            {expandedSections.includes('response') && (
              <div className="space-y-3 pb-3">
                <div>
                  ...
                  <Input type="text" placeholder="请输入" value={form.bidBody} onChange={(e) => set('bidBody', e.target.value)} className="w-full" />
                </div>
                ...
                <div>
                  ...
                  <Input type="text" placeholder="请输入" value={form.expectedPartners} onChange={(e) => set('expectedPartners', e.target.value)} className="w-full" />
                </div>
                ...
                <div>
                  ...
                  <RadioGroup value={form.isBid} onValueChange={(v) => set('isBid', v)}>
                    <div className="flex gap-4">
                      <label className="flex items-center gap-1.5 text-sm cursor-pointer">
                        <RadioGroupItem value="1" /> 是
                      </label>
                      <label className="flex items-center gap-1.5 text-sm cursor-pointer">
                        <RadioGroupItem value="0" /> 否
                      </label>
                    </div>
                  </RadioGroup>
                </div>
              ...
              {expandedSections.includes('win') && (
                <div className="space-y-3 pb-3">
                  <div>
                    ...
                    <Input type="date" value={form.bidTime} onChange={(e) => set('bidTime', e.target.value)} className="w-full" />
                  </div>
                  ...
                  <div>
                    ...
                    <Input type="number" placeholder="请输入" value={form.winBidAmount} onChange={(e) => set('winBidAmount', e.target.value)} className="w-full" />
                  </div>
                  ...
                  <div>
                    ...
                    <Input type="date" value={form.winBidTime} onChange={(e) => set('winBidTime', e.target.value)} className="w-full" />
                  </div>
                  ...
                  <div>
                    ...
                    <Input type="text" placeholder="请输入" value={form.contractObject} onChange={(e) => set('contractObject', e.target.value)} className="w-full" />
                  </div>
                  ...
                  <div>
                    ...
                    <Input type="text" placeholder="请输入" value={form.customerContact} onChange={(e) => set('customerContact', e.target.value)} className="w-full" />
                  </div>
                  ...
                  <div>
                    ...
                    <Input type="text" placeholder="请输入" value={form.customerContactPhone} onChange={(e) => set('customerContactPhone', e.target.value)} className="w-full" />
                  </div>

                  <div>
                    <label className="text-xs text-gray-500 block mb-1">项目期望完成时间</label>
                    <Input type="date" value={form.expectedCompleteTime} onChange={(e) => set('expectedCompleteTime', e.target.value)} className="w-full" />
                  </div>
              ...
              {expandedSections.includes('signed') && (
                <div className="space-y-3 pb-3">
                  <div>
                    ...
                    <Input type="date" value={form.businessNegotiationTime} onChange={(e) => set('businessNegotiationTime', e.target.value)} className="w-full" />
                  </div>
                  ...
                  <div>
                    ...
                    <Input type="number" placeholder="请输入" value={form.signAmount} onChange={(e) => set('signAmount', e.target.value)} className="w-full" />
                  </div>

                  <div>
                    <label className="text-xs text-gray-500 block mb-1">签约时间</label>
                    <Input type="date" value={form.signTime} onChange={(e) => set('signTime', e.target.value)} className="w-full" />
                  </div>
              ...
              {expandedSections.includes('lose') && (
                <div className="space-y-3 pb-3">
                  <div>
                    ...
                    <Input type="date" value={form.bidTime2} onChange={(e) => set('bidTime2', e.target.value)} className="w-full" />
                  </div>
                  ...
                  {form.loseReason === '8' && (
                    <div>
                      ...
                      <Textarea placeholder="请输入" value={form.loseReasonOther} onChange={(e) => set('loseReasonOther', e.target.value)} className="w-full" rows={3} />
                    </div>
                  )}
                </div>
              )}
                  ...
                  {form.isApprove === '1' && (
                    <>
                      <div>
                        ...
                        <Input type="text" placeholder="请输入" value={form.approver} onChange={(e) => set('approver', e.target.value)} className="w-full" />
                      </div>
                      ...
                      <div>
                        ...
                        <Input type="text" placeholder="请输入" value={form.approverHrCode} onChange={(e) => set('approverHrCode', e.target.value)} className="w-full" />
                      </div>

                      <div>
                        <label className="text-xs text-gray-500 block mb-1">审批人手机号</label>
                        <Input type="text" placeholder="请输入" value={form.approverPhonenumber} onChange={(e) => set('approverPhonenumber', e.target.value)} className="w-full" />
                      </div>
                      ...
                      <div>
                        ...
                        <Input type="date" value={form.qbFqTime} onChange={(e) => set('qbFqTime', e.target.value)} className="w-full" />
                      </div>
                      ...
                      <div>
                        ...
                        <Input type="date" value={form.qbTgTime} onChange={(e) => set('qbTgTime', e.target.value)} className="w-full" />
                      </div>
                    </>
                  )}
                </div>
              ...
              {expandedSections.includes('notOpen') && (
                <div className="space-y-3 pb-3">
                  <div>
                    ...
                    <Textarea placeholder="请输入未开标原因" value={form.notOpenReason} onChange={(e) => set('notOpenReason', e.target.value)} className="w-full" rows={3} />
                  </div>
                </div>
              )}
            </div>
                ...
                <div className="space-y-3 pb-3">
                  ...
                  {form.failResult === '3' && (
                    <div>
                      ...
                      <Textarea placeholder="请输入" value={form.failReasonOther} onChange={(e) => set('failReasonOther', e.target.value)} className="w-full" rows={3} />
                    </div>
                  )}
                </div>
              )}
