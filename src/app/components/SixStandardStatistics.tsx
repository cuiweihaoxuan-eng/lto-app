...
export function SixStandardStatistics() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-[#EFF4FC]">
      ...
      {viewLevel === 'province' && (
        <div
          className="absolute bottom-0 left-0 right-0 z-10 max-h-[72vh] overflow-y-auto bg-white/80 backdrop-blur-lg rounded-t-2xl shadow-[0_-2px_16px_rgba(0,0,0,0.06)]"
